...
# March 29th, 2015
# 
# Generates a further extended encoding in CNF and outputs to a file called: "extendedEncoding2.txt"

#!/usr/bin/python
import helperLibrary

def buildClauses():
    file = open('extendedEncoding2.txt', 'w+')
    file.write('c The extended encoding part 2\n')
    file.write('p cnf 729 11826\n')
